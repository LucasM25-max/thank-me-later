(() => {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      /* Hidden until GitHub is actually selected. !important is intentional because
         .pending span in the app stylesheet also uses display rules. */
      ...
      /* Keep typed text clear of the standalone + connector control. */
