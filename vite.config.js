...
const injectModelCatalog = () => ({
  ...
  ['gemini-flash-lite-latest', 'Gemini 3.5 Flash-Lite · 37']
    ...
    // Mount the existing Translate tool directly from its React component lifecycle.
    // This is the reliable source of truth for the sidebar button; it does not depend
    // on matching the exact formatting of the sidebar JSX.
